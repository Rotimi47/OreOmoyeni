...
export default function Skills() {
  return (
    <div
      data-aos="fade-up"
      className="w-full flex flex-col mx-auto px-4 py-15 gap-8 max-w-7xl lg:px-20 lg:py-18 2xl:max-w-380 2xl:mx-auto"
    >
      ...
      <div className="flex justify-between">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4  justify-items-center">
          ...
          <div className="w-full max-w-60">
            ...
            <div className="border border-white p-2">
              <p className="text-[#ABB2BF]">VSCode GitHub Figma Linux</p>
            </div>
          </div>
          <div className="w-full max-w-60 lg:col-start-2">
            ...
            <div className="border border-white p-2">
              <p className="text-[#ABB2BF]">REACT NEXT.js NODE.js</p>
            </div>
          </div>
          <div className="w-full max-w-60">
            <div className="border border-white p-2">
            ...
            <div className="border border-white p-2">
              <p className="text-[#ABB2BF]">
                Framer Motion Gsap Axios Zustand Zod Tanstack
              </p>
            </div>
          </div>
        </div>
